...
export function applyCounselingStateDelta({
  ...
  // A completely empty delta is valid: the turn had nothing worth storing.
  // If the model attempted state items but every item was malformed, keep the
  // previous revision so the same message can still be retried safely.
