  ...
  const turnRequirements = [
    ...
    focusTask === 'correction' && correctionAudit
      ? correctionAudit.priorAssistantMatch === false
        ? '- 정정 요청입니다. CORRECTION AUDIT에서 priorAssistantMatch=false입니다. 최근 assistant 답변에 사용자가 지적한 주장이 없습니다. "제가 앞서 그렇게 말했습니다"라고 허위로 인정하지 마세요. 그 주장을 사용자 사실로 저장하지 말고, transcript에 그 전제가 없었음을 짧게 정리한 뒤 원래 주제로 돌아가세요.'
