...
export function buildCounselingOrchestratorDiagnostic({
  ...
  return {
    ...
    timingGrounded: Boolean(evidencePacket?.timingMonthGrounded),
    timingYearGrounded: Boolean(evidencePacket?.timingYearGrounded),
    timingMonthGrounded: Boolean(evidencePacket?.timingMonthGrounded)
  };
}
